...
var FilterInputRadio = _reactAddons2['default'].createClass({
    ...
    _getLabel: function _getLabel() {
        return _lodash2['default'].isString(this.props.label) ? this.props.label : _lodash2['default'].isObject(this.props.schema) && _lodash2['default'].has(this.props.schema, 'label') ? this.props.schema.title : this.props.name;
    },
    ...
    render: function render() {
        ...
        return _reactAddons2['default'].createElement(
            ...
            _reactAddons2['default'].createElement(
                RadioGroup,
                { ref: 'group', name: this.props.name, value: value, onChange: this.onClickRadio },
