...
exports['default'] = _reactAddons2['default'].createClass({
    ...
    _getTitle: function _getTitle() {
        ...
        return _lodash2['default'].isString(this.props.title) ? this.props.title : _lodash2['default'].isObject(this.props.schema) && _lodash2['default'].has(this.props.schema, 'title') ? this.props.schema.title : null;
    },
    ...
    render: function render() {
        ...
        var minContent = hasMin ? _reactAddons2['default'].createElement(
            ...
            preMinContent,
            _reactAddons2['default'].createElement(_reactWidgetsLibDateTimePicker2['default'], { onChange: this.onChangeMinDate }),
            postMinContent
        ) : null;
        ...
        var maxContent = hasMax ? _reactAddons2['default'].createElement(
            ...
            preMaxContent,
            _reactAddons2['default'].createElement(_reactWidgetsLibDateTimePicker2['default'], { onChange: this.onChangeMaxDate }),
            postMaxContent
        ) : null;
