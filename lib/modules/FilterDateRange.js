...
exports['default'] = _reactAddons2['default'].createClass({
    ...
    render: function render() {
        ...
        var minContent = hasMin ? _reactAddons2['default'].createElement(
            ...
            preMinContent,
            _reactAddons2['default'].createElement(_reactWidgetsLibDateTimePicker2['default'], _extends({ onChange: this.onChangeMinDate }, pickerProps)),
            postMinContent
        ) : null;
        ...
        var maxContent = hasMax ? _reactAddons2['default'].createElement(
            ...
            preMaxContent,
            _reactAddons2['default'].createElement(_reactWidgetsLibDateTimePicker2['default'], _extends({ onChange: this.onChangeMaxDate }, pickerProps)),
            postMaxContent
        ) : null;
